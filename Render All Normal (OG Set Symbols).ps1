...
java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=M15 --copyright=false --use_card_back=false
ProxyRename "NONE"
...
java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=FANG --copyright=false --use_card_back=false
ProxyRename "FANG"

java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=M10 --copyright=false --use_card_back=false
ProxyRename "M10"

java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=SSDFC --copyright=false --use_card_back=false
ProxyRename "SSDFC"

java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=MaleMPC --copyright=false --use_card_back=false
ProxyRename "MaleMPC"

java -jar proximity.jar --cards=Decklist.txt --art_source=LOCAL --reminder_text=true --template=Extended --copyright=false --use_card_back=false
